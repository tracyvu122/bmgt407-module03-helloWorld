...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'tracyvu', 'email': 'tracyvu@terpmail.umd.edu', 'first_name': 'Tracy', 'last_name': 'Vu',
         'password': generate_password_hash('tracyvu', method='pbkdf2:sha256'), 'role': 'STUDENT'}
    ]
    ...
    students = [
        ...
        {'first_name': 'Tracy', 'last_name': 'Vu', 'email': 'tracyvu@terpmail.umd.edu',
         'major_id': 3, 'birth_date': dt.strptime('2004-01-22', '%Y-%m-%d'), 'is_honors': 1}
    ]
